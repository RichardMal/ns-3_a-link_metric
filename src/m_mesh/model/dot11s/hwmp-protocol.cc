...
//#include "hop-count-metric.cc" //Richard:using this line as a crude fix to gain some understanding of the cause of, "undefined reference to HopCountLinkMetricCalculator" error
